...
local function Kill(Model)
    if _G.Code1 ~= nil and _G.Code2 ~= nil and Model:FindFirstChild("Torso") then
        ...
        local ToClaim = game.Players.LocalPlayer.Character:WaitForChild(CurrentWeapon,5)
        if ToClaim == nil then
            return
        end
...
--]]
    ...
    if key == "o" and _G.Code1 ~= nil and _G.Code2 ~= nil and Debounces.Trap == false then
        Debounces.Trap = true
...
if _G.Code1 ~= nil and _G.Code2 ~= nil then
    game.StarterGui:SetCore("SendNotification", {
        Title = 'GOODWILL';
        Text = "SUCCESSFULLY INJECTED, HOLD T AND CLICK GOODWILL FOR CMDS                   (MADE BY AIDEZ)";
        Icon = "rbxassetid://2541869220";
        Duration = 7;
    })
print([[
